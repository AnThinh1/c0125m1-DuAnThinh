function addNewSmartPhone() {
    ...
    $.ajax({
        ...
        //tên API
        url: "http://localhost:8080/Gradle___com_codegym___mobile_shop_1_0_SNAPSHOT_war/api/smartphones",
...
function deleteSmartphone(id) {
    $.ajax({
        type: "DELETE",
        url: `http://localhost:8080/Gradle___com_codegym___mobile_shop_1_0_SNAPSHOT_war/api/smartphones/${id}`,
        success: successHandler
    });
}